        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Users_Role", "[Role] BETWEEN 1 AND 3");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_MenuItems_PreparationMinutes", "[PreparationMinutes] BETWEEN 1 AND 240");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Orders_Amounts", "[Subtotal] >= 0 AND [TaxAmount] >= 0 AND [DeliveryFee] >= 0 AND [TotalAmount] >= 0");
                    table.CheckConstraint("CK_Orders_Status", "[Status] BETWEEN 1 AND 5");
                    table.CheckConstraint("CK_Orders_Type", "[Type] BETWEEN 1 AND 3");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_DailyMenuItems_QuantityAvailable", "[QuantityAvailable] IS NULL OR [QuantityAvailable] >= 0");
                    table.CheckConstraint("CK_DailyMenuItems_QuantitySold", "[QuantitySold] >= 0");
                    table.CheckConstraint("CK_DailyMenuItems_SpecialPrice", "[SpecialPrice] IS NULL OR [SpecialPrice] > 0");
                    table.ForeignKey(
                        name: "FK_DailyMenuItems_MenuItems_MenuItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyMenuItems_MenuDate",
                table: "DailyMenuItems",
                column: "MenuDate");

            migrationBuilder.CreateIndex(
                name: "IX_DailyMenuItems_MenuDate_MenuItemId",
                table: "DailyMenuItems",
                columns: new[] { "MenuDate", "MenuItemId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DailyMenuItems_MenuItemId",
                table: "DailyMenuItems",
                column: "MenuItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItems_IsDeleted_IsAvailable_CategoryId",
                table: "MenuItems",
                columns: new[] { "IsDeleted", "IsAvailable", "CategoryId" });
